...
class ANN_thermo1(nn.Module):
    def __init__(self, input_dim, lr, activation, epochs, batch_size, loss,
        ...
        self.branch_entropy = ANNBranch1(input_dim, self.activation)
        self.branch_energy = ANNBranch1(input_dim, self.activation)
        self.branch_feng = ANNBranch1(input_dim, self.activation)
