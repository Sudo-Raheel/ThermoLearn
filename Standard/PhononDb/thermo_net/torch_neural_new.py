...
class ANN_thermo1(nn.Module):
    def __init__(self, input_dim,wht,s1,s2, lr, activation, epochs, batch_size, loss,
        ...
        self.branch_entropy = ANNBranch1(input_dim,wht,s2, self.activation)
        self.branch_energy = ANNBranch1(input_dim,wht,s1, self.activation)
        self.branch_feng = ANNBranch1(input_dim,wht,s2, self.activation)
    ...
    def custom_loss(self,output_entropy, output_energy,output_feng,target_entropy, target_energy, target_feng):
        ...
        expected_feng = output_energy/1.0 - (self.Temperature / 1000) * output_entropy
