...
# loading the data
data = pd.read_csv('total_nist.csv')
data = data.dropna()
print(len(data))
text_file = open("feature_rank1_energy_nist.txt", "r")
...
def main():
    ...
    param_grid = {
        'input_dim': [25],# Adjust the values based on your preference
        'wht':[0.9,0.8,0.7],
        's1':[6,5,4,3],
        's2':[6,5,4,3],
        ...
        'w1': [1,2,3,4,5],
        'w2': [1,2,3,4,5],
        'w3': [10,15,20,25,30,35,40,45,50,55],
    ...
    avg_r2_df.to_csv('raheel_score4.csv', index=False)
